...
Builtins.pos = function(x) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, arguments.callee);
    return +x;
}

Builtins.neg = function(x) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, arguments.callee);
    return -x;
}

Builtins.bnot = function(x) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, arguments.callee);
    return ~x;
}

Builtins.lnot = function(x) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, arguments.callee);
    return !x;
}

Builtins.shl = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return x << y;
}

Builtins.shr = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return x >> y;
}
...
Builtins.le = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return x <= y;
}

Builtins.ge = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return x >= y;
}

Builtins.band = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return x & y;
}

Builtins.bxor = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return x ^ y;
}

Builtins.bor = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return x | y;
}

Builtins.land = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return x && y;
}

Builtins.lxor = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return (x && !y) || (!x && y);
}

Builtins.lor = function(x, y) {
    if (x instanceof Runtime.vec)
        return this._evalVec(x, y, arguments.callee);
    return x || y;
}

// Question: How to pass in gl_* ?
var gl_FragCoord; // input from somewhere

function(time, mouse, resolution, r) {
    var col = r.vec3(0.1, 0.2, 0.3);
    var pos = r.get(gl_FragCoord, "x", "y").divide(r.get(resolution, "x", "y"));
    ...
    if (pos.y > 0.1 && pos.y < 0.9)
    	gl_FragColor = r.vec4(1, 1, 1, 1.0);
    else
        gl_FragColor = r.vec4(0.9, 0.9, 0.9, 1.0);
